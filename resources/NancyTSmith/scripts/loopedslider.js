...
if(typeof jQuery != 'undefined') {
	jQuery(function($) {
		...
		$.fn.loopedSlider.defaults = {
			container: ".slideContainer", //Class/id of main container. You can use "#container" for an id.
			slides: ".slides", //Class/id of slide container. You can use "#slides" for an id.
			pagination: "bannerpagination", //Class name of parent ul for numbered links. Don't add a "." here.
